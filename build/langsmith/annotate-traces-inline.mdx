...
Inline feedback and notes in the LangSmith UI do not change the trace's retention tier; the trace keeps the retention configured for its project unless another action explicitly extends retention.
