...
- **Resize charts**: hover any edge or corner of a chart. Horizontal handles widen/narrow, vertical handles change height, corners resize both at once. Layout is saved automatically.
...
- **Cross-chart hover**: hovering over a timestamp on any time-series chart draws a synced crosshair across every other time-series chart in the dashboard, so you can find the same instant across multiple metrics.
