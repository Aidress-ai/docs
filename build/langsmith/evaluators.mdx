...
Thread evaluators do not force trace retention upgrades by default; if a thread's project already uses extended retention, the project setting still applies.
