...
<Note>Multi-turn online evaluators do not force trace retention upgrades by default; traces keep the project's configured retention tier unless another configured action explicitly extends retention or the project already uses extended retention. For details, see [data retention auto-upgrades](/langsmith/usage-and-billing#data-retention-auto-upgrades).</Note>
