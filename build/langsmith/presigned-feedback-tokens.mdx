...
Feedback submitted with a presigned URL uses the feedback API's default retention behavior and can extend a base-retention trace to extended retention.
