...
If you enable [Sandboxes](/langsmith/deploy-self-hosted-full-platform#sandboxes), also mirror the sandbox runtime image. The sandbox runtime image is published for `linux/amd64`.
