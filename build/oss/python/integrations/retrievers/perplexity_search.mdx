...
We can use this as a [retriever](/oss/python/langchain/retrieval). It will show functionality specific to this integration. After going through, it may be useful to explore [relevant use-case pages](/oss/python/deepagents/rag) to learn how to use this retriever as part of a larger chain.
