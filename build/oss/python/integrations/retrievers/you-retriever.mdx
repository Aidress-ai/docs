...
Install the `langchain-youdotcom` package and set your You.com API key. Get your API key at [you.com/platform](https://you.com/platform).
...
It's also helpful (but not needed) to set up [LangSmith](https://smith.langchain.com/?utm_source=docs&utm_medium=cta&utm_campaign=langsmith-signup&utm_content=oss-python-integrations-retrievers-you-retriever) for best-in-class observability.
