...
description: Lightning-fast semantic search engine and vector store using Maximally
  Informative Binarization (MIB) and Information-Theoretic Score (ITS)
integration:
  name: Moorcheh
  pypi: langchain-moorcheh
---
